...
module.exports = {
    ...
    createSubforumPost: async (req, res) => {
        ...
        let post = await db.post.create_subforum_post(post_title, post_content, post_author_id, subforumId, post_type_id, post_time)
    ...
    updateSubforumPost: async (req, res) => {
        ...
        let udpatedPost = await db.post.update_post(postId, subforumId, post_title, post_content)
